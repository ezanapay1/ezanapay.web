...
import { EnvelopeIcon, IdentificationIcon, PhoneIcon, UserIcon, UserPlusIcon } from '@heroicons/react/24/outline';
						...
						<div className='flex-1'>
							<div className="grid grid-cols-2 gap-5">
								<div className="flex space-x-2 items-center">
									...
									<span className='text-sm font-semibold'>123456</span>
								</div>
								<div className="flex space-x-2 items-center">
								...
								<div className="flex space-x-2 items-center">
									...
									<span className='text-sm font-semibold'>+25471234567</span>
								</div>
								<div className="flex space-x-2 items-center">
