					...
					<div className="landing-item-inner">
						<div className="landing-item landlords">
							...
							<div className="">
								...
								<div className="">
									<h2>Gain control and simplify your property management with our technology</h2>
									<ul>
										...
										<li className="flex space-x-2 items-center">
											<HomeModernIcon className="h-8 text-primary" />
											<h1>Streamline communication with tenants and property managers</h1>
										</li>
										<li className="flex space-x-2 items-center">
											<HomeModernIcon className="h-8 text-primary" />
											<h1>Easily vet new tenants with a tenant credit score</h1>
										</li>
										<li className="flex space-x-2 items-center">
											<HomeModernIcon className="h-8 text-primary" />
											<h1>Access accurate reports and up-to-date information with just a few clicks</h1>
										</li>
									</ul>
								</div>
							</div>
							<div className="landing-item-desc">
								Say goodbye to the chaos and frustration of manual record-keeping on excel sheets and hello to  
								an organized, time-saving, and cost-effective solution.
							</div>
						</div>
					</div>
					<div className="landing-item prop-managers">
						<div className="landing-item-inner">
							...
							<div className="">
								...
								<div className="">
									<ul>
										<h2>Improve efficiency and productivity with our technology</h2>
										<li className="flex space-x-2 items-center">
										...
										<li className="flex space-x-2 items-center">
											<BanknotesIcon className="h-8 text-primary" />
											<h1>Communication with tenants and landlords effectively</h1>
										</li>
										<li className="flex space-x-2 items-center">
											<BanknotesIcon className="h-8 text-primary" />
											<h1>Access real-time information and reports</h1>
										</li>
										<li className="flex space-x-2 items-center">
											<BanknotesIcon className="h-8 text-primary" />
											<h1>Streamline property management tasks with just a few clicks</h1>
										</li>
										<li className="flex space-x-2 items-center">
											<BanknotesIcon className="h-8 text-primary" />
											<h1>Track and reconcile payments made to your Landlords</h1>
										</li>
									</ul>
								</div>
							</div>
						...
						<div className="landing-item-desc">
						Join the revolution and start experiencing the benefits of technology in rent payment and  
						property management today. Sign up now and experience the ease, convenience, and peace of  
						mind that comes with our innovative solution.
						</div>
					</div>
				</div>
			</div>
