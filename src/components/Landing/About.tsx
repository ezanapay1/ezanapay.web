  ...
  return (
    <div className="bg-gray-50 items-center flex justify-center">
      <p className="text-center leading-loose w-auto text-2xl tracking-wide p-24">
        ...
        <span className="text-primary">Look no further!</span> Our innovative
        technology is here to revolutionize the way you{" "}
        <span className="text-primary">pay rent</span> and <span className="text-primary">manage your property</span>.
      </p>
    </div>
  );
};
