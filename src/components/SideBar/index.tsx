import { ArrowRightOnRectangleIcon, DocumentDuplicateIcon, HomeModernIcon, UserCircleIcon, UserGroupIcon, WalletIcon } from '@heroicons/react/24/outline'
    ...
    <div className='p-10'>
        <div className='w-56 h-[80vh] p-5 flex flex-col justify-between bg-primary/5 rounded-lg shadow-lg'>
            <ul className='flex flex-col space-y-5'>
                <li  className='bg-gray-200 p-2 rounded-md flex items-center text-sm font-semibold space-x-3'><UserCircleIcon className='h-8 text-primary' /><Link to="/landlord/profile"> User Profile</Link></li>
            ...
            <div className='flex items-center justify-center space-x-1'>
                ...
                <span className='text-gray-700 font-light tracking-wide'>Logout</span>
            </div>
        </div>
    </div>
  )
